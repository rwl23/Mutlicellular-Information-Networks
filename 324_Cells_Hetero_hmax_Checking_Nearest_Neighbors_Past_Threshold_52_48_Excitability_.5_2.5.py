...
np.savez("324_Cells_Hetero_hmax_Checking_Nearest_Neighbors_Past_Threshold_52_48_Excitability_.5_2.5_Results", g = g, ave_number_of_edges_list = ave_number_of_edges_list, std_number_of_edges_list = std_number_of_edges_list, ave_number_of_peaks_list = ave_number_of_peaks_list, std_number_of_peaks_list = std_number_of_peaks_list)


#plt.figure(1)
#plt.scatter(g, ave_number_of_edges_list)
#plt.xscale('log')

#plt.figure(2)
#plt.scatter(g, ave_number_of_peaks_list)
#plt.xscale('log')