...
np.savez("169_Cells_Pedge_FiringFrac_Results", g = g, ave_number_of_edges_list = ave_number_of_edges_list, std_number_of_edges_list = std_number_of_edges_list, ave_number_of_peaks_list = ave_number_of_peaks_list, std_number_of_peaks_list = std_number_of_peaks_list)
